   ...
   <header>
        <div class="header-content">
           ...
           <div class="home-header">&nbsp;</div>
                ...
                <img src="/wp-content/themes/hirefilipino/img/logo-bg.png" width="450">
                <hr>
                <img src="/wp-content/themes/hirefilipino/img/tagline.png" width="450">
                
                <div class="btn-container">
         	<div class="col-lg-8 col-lg-offset-2 text-center">
         	<div class="col-lg-6">
			<h4><span style="color:#ffff00">Filipino</span> Virtual Worker?</h4>
            <a href="#" class="btn btn-primary btn-xl">Sign up Here</a>
            </div>
            <div class="col-lg-6">
            <h4>For Employers</h4>
            <a href="#" class="btn btn-primary btn-xl">Sign up Here</a>
            ...
            <p style="padding-top:50px">The Filipino is renowned all over the world for his work in multiple fields of the industry, not to mention also Hardworking, with strong Integrity, Perseverance and the vibe of not giving up. This website opens and connects this Qualities for hire to the rest world. </p>
            </div>
            </div>
